...
<body>
	...
	<div class="content container_12">
		...
		<div class="box grid_5">
			...
			<form method="post" action="CheckTemplateNameServlet">
				<div class="box-content">
					...
					<div class="form-row">
						...
						<div class="form-item">
							...
							<input type="text" name="templateName"
								value=<%=request.getAttribute("templateName")%> required
								disabled />
							<%
								} else {
							%>
					...
					<div class="form-row" style="text-align: right;">
						<input type="submit" class="button green" value="start">
					</div>
				</div>
			</form>
		</div>
